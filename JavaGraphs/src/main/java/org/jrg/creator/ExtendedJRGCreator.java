...
public class ExtendedJRGCreator {
    ...
    private static final File dbDir = new File( "neo4jDB/Server" );
	...
	public static enum RelTypes implements RelationshipType {
	 ...
	 // use for measuring time
	  public static void main(String args[]) {
		  ...
		  ExtendedJRGCreator db= new ExtendedJRGCreator();
	 
//	 for (int i=0; i<=4; i++) 
//	 { 
	//	 db.initializeDB("StackProject", "D:\\ritu\\Research-2018\\ICSIM2019\\DownloadedGitProjects\\redisson-master");
		 db.initializeDB("StackProject", "C:\\ritu\\eclipseWorkspaces\\StackProject");
...
//			registerShutdownHook(graphDb);
			...
			if (dependencyFile == null)
				System.out
						.println(" Dp is  null after initializeDependencyEdgesFile");
